...
public class nagarnigam_dept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(nagarnigam_dept.this, HomeActivity.class);
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            if (desc.isEmpty()) {
                Toast.makeText(nagarnigam_dept.this, "⚠ Please enter description!", Toast.LENGTH_SHORT).show();
                return;
            }

            Toast.makeText(nagarnigam_dept.this,
