...
public class pwd_dept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(pwd_dept.this, HomeActivity.class);
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            if (desc.isEmpty()) {
                Toast.makeText(pwd_dept.this, " Please enter description!", Toast.LENGTH_SHORT).show();
                return;
            }

            Toast.makeText(pwd_dept.this,
